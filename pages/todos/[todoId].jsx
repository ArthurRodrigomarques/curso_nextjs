...
export default function Todo({todo}) {
    ...
    return (
        <>
            ...
            <p>Comentário: lae lae lae... <Link href={`/todos/${todo.id}/comments/2`}>Detalhes</Link></p>
            <p>Comentário: lau lau lau... <Link href={`/todos/${todo.id}/comments/3`}>Detalhes</Link></p>
        </>
    )
}